  ...
  return knex('answers').del()
    .then(function () {
      ...
      const answers = [
          ...
          { choice: 'Music consists of harmony, beats, rythms, and melodies.', question_id: 6 },
          ...
          { choice: 'I use both laptop and phone, but more importantly, I want to be able to pick up where I left off when switching.', question_id: 7 },
